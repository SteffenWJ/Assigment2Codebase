...
#include "bram_uio.h"
#include "src/KalmanFilterKernel-driver/src/xkalmanfilterkernel.h"
#include "src/KalmanFilterKernel-driver/src/xkalmanfilterkernel_hw.h" //added to the nodes
