...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:KalmanFilterKernel:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: KalmanFilterKernel_0, and set properties
  set KalmanFilterKernel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:KalmanFilterKernel:1.0 KalmanFilterKernel_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins KalmanFilterKernel_0/s_axi_AXI_CPU] [get_bd_intf_pins axi_smc/M02_AXI]
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_bram_ctrl_1/S_AXI] [get_bd_intf_pins axi_smc/M03_AXI]
  ...
  connect_bd_net -net KalmanFilterKernel_0_din_address0 [get_bd_pins KalmanFilterKernel_0/din_address0] [get_bd_pins bram_addr_mapper_0/addr_in]
  connect_bd_net -net KalmanFilterKernel_0_din_ce0 [get_bd_pins KalmanFilterKernel_0/din_ce0] [get_bd_pins axi_bram_ctrl_0_bram/enb]
  connect_bd_net -net KalmanFilterKernel_0_dout_address0 [get_bd_pins KalmanFilterKernel_0/dout_address0] [get_bd_pins bram_addr_mapper_1/addr_in]
  connect_bd_net -net KalmanFilterKernel_0_dout_ce0 [get_bd_pins KalmanFilterKernel_0/dout_ce0] [get_bd_pins axi_bram_ctrl_1_bram/enb]
  connect_bd_net -net KalmanFilterKernel_0_dout_d0 [get_bd_pins KalmanFilterKernel_0/dout_d0] [get_bd_pins axi_bram_ctrl_1_bram/dinb]
  connect_bd_net -net KalmanFilterKernel_0_dout_we0 [get_bd_pins KalmanFilterKernel_0/dout_we0] [get_bd_pins bram_addr_mapper_1/wr_in]
  connect_bd_net -net KalmanFilterKernel_0_interrupt [get_bd_pins KalmanFilterKernel_0/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins KalmanFilterKernel_0/din_q0] [get_bd_pins axi_bram_ctrl_0_bram/doutb]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins KalmanFilterKernel_0/ap_rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins bram_addr_mapper_0/n_rst_in] [get_bd_pins bram_addr_mapper_1/n_rst_in] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs KalmanFilterKernel_0/s_axi_AXI_CPU/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0008000 -range 0x00008000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
